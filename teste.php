...
<html lang="pt-br">
  <head>
    ...
    <link rel="stylesheet" href="../html/src/css/teste.css">
     <link rel="shortcut icon" href="../html/src/img/spacecolorlogo.jpg">
  </head>
  <body>
    <header>
    ...
    <img src="" alt="" id="moon">
     <img src="../html/src/img/fumaça.png" alt="" id="mountains_behind">
      <h2 id="text">Partiu tripulantes!🚀</h2>
      <a href="../html/spacecolor.html" id="btn">Pintar</a>
      <img src="../html/src/img/crianças.png" alt="" id="mountains_front">
       </section>
       ...
       <div class="sec" id="sec">
        ...
        <ol>
          ...
          <li>Você pode escolher formas geométricas, e todas as cores que quiser para fazer seus desenhos. Também estão disponíveis desenhos já prontos para quem deseja apenas colorir, eles estão acompanahados de informações divertidas sobre esse vasto universo! Para acessá-los, clique no botão "Desenhos".</li>
